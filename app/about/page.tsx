...
// Chat Logo Component - same as in main page for consistency
  ...
  return (
    <div className="flex w-full h-screen bg-zinc-50">
      <div className="flex-1 flex flex-col min-w-0 relative">
        ...
        <div className="absolute inset-0 bg-[radial-gradient(#e0e0e0_1px,transparent_1px)] [background-size:16px_16px] pointer-events-none" />
        
        <div className="flex-1 flex flex-col items-center justify-center px-4 relative z-10">
          {/* White container for content */}
          <div className="bg-white rounded-2xl shadow-sm border border-zinc-100 p-8 w-full max-w-3xl relative z-20">
            ...
            <div className="prose prose-zinc max-w-none">
              ...
              <h2 className="text-xl font-medium mt-8 mb-4 text-zinc-800">Our Mission</h2>
              <p className="text-zinc-600 mb-4">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. 
                Integer nec odio. Praesent libero. Sed cursus ante dapibus diam.
              </p>
              
              <h2 className="text-xl font-medium mt-8 mb-4 text-zinc-800">Features</h2>
              <ul className="list-disc pl-6 text-zinc-600 mb-6 space-y-2">
                ...
                <li>Duis sagittis ipsum. Praesent mauris. Fusce nec tellus sed augue semper porta.</li>
                <li>Mauris massa. Vestibulum lacinia arcu eget nulla.</li>
              </ul>
              
              <h2 className="text-xl font-medium mt-8 mb-4 text-zinc-800">How It Works</h2>
              <p className="text-zinc-600 mb-4">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. 
                Integer nec odio. Praesent libero. Sed cursus ante dapibus diam.
              </p>
              
              <h2 className="text-xl font-medium mt-8 mb-4 text-zinc-800">Contact Us</h2>
              <p className="text-zinc-600">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. 
                Integer nec odio. Praesent libero. Sed cursus ante dapibus diam. 
                Please visit our <Link href="/help" className="text-blue-600 hover:underline">Help page</Link> for more information.
              </p>
            </div>
          </div>
          
          {/* Footer links */}
          <div className="flex gap-6 text-xs text-zinc-500 mt-6">
            <Link href="/" className="hover:text-zinc-800 transition-colors">Home</Link>
            <Link href="/help" className="hover:text-zinc-800 transition-colors">Help</Link>
          </div>
        </div>
      </div>
    </div>
